...
public class ConstEntities
{
	...
	/// </summary>
	public static readonly UserGroup AdminUserGroup = new()
	{
	...
	/// </summary>
	public static readonly UserGroup DefaultUserGroup = new()
	{
	...
	/// </summary>
	public static readonly UserState ActiveUserState = new()
	{
	...
	/// </summary>
	public static readonly UserState BlockedUserState = new()
	{
